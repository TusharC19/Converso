                    ...
                    {companions?.map(({id,subject,name,topic,duration}) => (
                        ...
                        <TableRow key={id}>
                            ...
                            <TableCell>
                                ...
                                <div className="flex items-center justify-center rounded-lg w-fit p-2md:hidden"
                                style={{backgroundColor:getSubjectColor(subject)}}>
                            ...
                            <TableCell>
                                <div className="flex items-center gap-2 w-full justify-end">
                                    <p className="text-2xl">{duration} {' '} <span className="max-md:hidden">mins</span>
                                    </p>
